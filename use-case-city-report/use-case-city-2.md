#USE CASE: 2 All the cities in a continent organised by largest population to smallest.
##CHARACTERISTIC INFORMATION
###Goal in Context

As an *Executive Director* I want *to produce a report on all population in the continent by cities * so that *I can support financial reporting of the organisation.*
###Scope
