#USE CASE: 10 The top 10 populated cities in a district where 10 is provided by the user.
##CHARACTERISTIC INFORMATION
###Goal in Context

As an *Executive Director* I want *to produce a report on top 10 populated cities in a district by user * so that *I can support financial reporting of the organisation.*
###Scope
