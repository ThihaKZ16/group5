#USE CASE: 3 All the cities in a region organised by largest population to smallest.
##CHARACTERISTIC INFORMATION
###Goal in Context

As an *Executive Director* I want *to produce a report on all population in a region by cities * so that *I can support financial reporting of the organisation.*
###Scope
